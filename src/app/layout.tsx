        ...
        <header className="border-b border-stone-200 bg-white shadow-sm dark:border-stone-800 dark:bg-stone-900" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
          <div className="mx-auto max-w-7xl px-4 py-3 flex items-center gap-3">
            ...
            <div className="ml-auto sm:ml-3 flex items-center gap-2">
              ...
              <a href="/packing-library" className="text-xs font-medium text-stone-500 hover:text-stone-800 bg-stone-100 hover:bg-stone-200 dark:text-stone-400 dark:hover:text-stone-100 dark:bg-stone-800 dark:hover:bg-stone-700 rounded-lg px-3 py-1.5 transition-colors">
                🎒 Packing
              </a>
